...
$originalCounts = [0,0,0];

$originalPath = "processed.csv"; // dataset sebelum balancing

if(file_exists($originalPath)){

    $file = fopen($originalPath,"r");
...
<p>Negatif : <?php echo $originalCounts[0]; ?></p>
<p>Netral  : <?php echo $originalCounts[1]; ?></p>
<p>Positif : <?php echo $originalCounts[2]; ?></p>
